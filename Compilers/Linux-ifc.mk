# svn $Id: Linux-ifc.mk 1169 2010-03-02 01:24:52Z kate $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ifdef USE_NETCDF4
    ...
    NETCDF_INCDIR ?= /home/mdinnima/netcdf/netcdf-3.6.0-p1/include
    NETCDF_LIBDIR ?= /home/mdinnima/netcdf/netcdf-3.6.0-p1/lib
endif
...
ifdef USE_DEBUG
 ...
 ifeq ($(CPU),x86_64)
           FFLAGS += -axT -fp-model precise -prec-sqrt
 endif
endif
