      MODULE step2d_mod
!
!svn $Id: step2d.F 1451 2012-02-02 20:56:14Z kate $
!=======================================================================
...
!
!svn $Id: step2d_LF_AM3.h 1451 2012-02-02 20:56:14Z kate $
!=======================================================================
!                                                                      !
...
!
     ...
     &          (pm(i-1,j-1)+pm(i,j-1))*ubar(i,j-1,krhs)))
          ...
          VFx(i,j)=on_p(i,j)*on_p(i,j)*cff
			  ! IF(i.eq.277 .and. j.eq.191) THEN
			  ! write(*,*)'CHECK I, 191 - visc2_p, Drhs_p'
			  ! write(*,*)visc2_p(277,191),Drhs_p(277,191)
			  ! write(*,*)'CHECK II - om_p, on_p, cff'
			  ! write(*,*)om_p(277,191),on_p(277,191),cff
			  ! END IF
			  ! IF(i.eq.277 .and. j.eq.190) THEN
			  ! write(*,*)'CHECK I, 190 - visc2_p, Drhs_p'
			  ! write(*,*)visc2_p(277,190),Drhs_p(277,190)
			  ! write(*,*)'CHECK III - om_p, on_p, cff'
			  ! write(*,*)om_p(277,190),on_p(277,190),cff
			  ! END IF
        END DO
      END DO
!
...
!
      DO j=Jstr,Jend
        DO i=IstrU,Iend
          ...
          rhs_ubar(i,j)=rhs_ubar(i,j)+fac
			  ! IF(i.eq.277 .and. j.eq.190) THEN
			  ! write(*,*)'CHECK IV - cff1, cff2'
			  ! write(*,*)cff1,cff2
			  ! write(*,*)'CHECK V - pn, pn, pm, pm'
		  ! write(*,*)pn(276,190),pn(277,190),pm(276,190),pm(277,190)
			  ! write(*,*)'CHECK VI - UFx, UFx, UFe, UFe'
	  ! write(*,*)UFx(277,190),UFx(276,190),UFe(277,191),UFe(277,190)
			 ! write(*,*)'Mark XIII horiz mix - rhs_ubar, rhs_vbar'
			 !  write(*,*)rhs_ubar(277,190)
			 !  END IF
        END DO
      END DO
      DO j=JstrV,Jend
