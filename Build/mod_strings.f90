      MODULE mod_strings
!
!svn $Id: mod_strings.F 1474 2012-05-29 15:15:08Z kate $
!================================================== Hernan G. Arango ===
...
!
     ...
     &      'Advection of ice tracers..........................'/)
        ...
        character (len=80) :: my_fort = "mpif90"
        character (len=80) :: my_fc = "/cm/shared/apps/openmpi/gcc/64/1.6.5/bin/mpif90"
        character (len=160) :: my_fflags = "-frepack-arrays -O3 -ffast-math -I/usr/include -ffree-form -ffree-form -ffree-form"
