      MODULE mod_scalars
!
!svn $Id: mod_scalars.F 1474 2012-05-29 15:15:08Z kate $
!================================================== Hernan G. Arango ===
...
!
        logical, allocatable :: ComposedGrid(:)
...
!
!  Switch indicating which tracer field need to be processed for
!  Sources/Sinks terms.
!
