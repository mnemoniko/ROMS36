     ...
     &                          rectangular)
!
!svn $Id: get_varcoords.F 1451 2012-02-02 20:56:14Z kate $
!================================================== Hernan G. Arango ===
...
!           IF (Master) THEN
!             PRINT *, 'Inside IF Aname = ', TRIM(var_Achar(i)), alen
!           END IF
            alen=alen-1
          END IF
          blank=INDEX(var_Achar(i)(1:alen),' ')
          Xname=var_Achar(i)(1:blank-1)
          Yname=var_Achar(i)(blank+1:alen)
          foundit=.TRUE.
          EXIT
        END IF
      END DO
