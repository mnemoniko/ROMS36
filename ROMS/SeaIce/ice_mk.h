...
# if !defined SOGLOBEC && !defined ROSS
...
#undef DIAG_WPB
     ...
     &              t2(i,j)
      END IF
#endif
!	    IF(i.eq.277 .and. j.eq.350) THEN
!	    print*,'hi and ai at 277,350: ',ai(277,350,linew),hi(277,350,linew)
!            ENDIF
        ENDDO
      ENDDO
...
!     IF(i.eq.277 .and. j.eq.350) THEN
!	    print*,'ai max, ai min, hi min:'
!	    print*,max_a(ng),min_a(ng),min_h(ng)
!     print*,'ai and hi II: ',ai(277,350,linew),hi(277,350,linew)
!     END IF
        ENDDO
      ENDDO
...
!     &                  ui, vi, ageice, LBC(:,isAgeice,ng),0)
